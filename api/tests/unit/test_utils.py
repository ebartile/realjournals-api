...
from apps.utils.urls import get_absolute_url, is_absolute_url, build_url, \
    validate_private_url, IpAddresValueError, HostnameException
from apps.utils.db import save_in_bulk, update_in_bulk, to_tsquery
...
def test_get_absolute_url():
    ...
    assert get_absolute_url("/path") == build_url("/path", domain="api.realjournals.com", scheme="https")
