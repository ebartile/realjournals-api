...
from rest_framework.auth.exceptions import TokenError
from rest_framework.auth.settings import api_settings
from rest_framework.auth.token_denylist.models import (
    DenylistedToken, OutstandingToken,
)
from rest_framework.auth.tokens import (
    AccessToken, RefreshToken
)
from rest_framework.auth.utils import aware_utcnow, datetime_from_epoch
...
def test_flush_expired_tokens_should_delete_any_expired_tokens():
    ...
    with patch('rest_framework.auth.tokens.aware_utcnow') as fake_aware_utcnow:
