    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('anon_permissions', django.contrib.postgres.fields.ArrayField(base_field=models.TextField(choices=[('view_account', 'View account'), ('view_journal', 'View journal')], default=[]), size=None)),
                ('username', models.IntegerField(default=0)),
                ('password', models.CharField(default='', max_length=100)),
                ('server', models.CharField(default='', max_length=100)),
                ('trade_mode', models.IntegerField(choices=[(0, 'Demo'), (1, 'Contest'), (2, 'Real')], default=2)),
                ...
                ('margin_mode', models.IntegerField(choices=[(0, 'Retail Netting'), (1, 'Exchange'), (2, 'Retail Hedging')], default=1)),
                ('margin_so_mode', models.IntegerField(choices=[(0, 'Percent'), (1, 'Money')], default=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('permissions', django.contrib.postgres.fields.ArrayField(base_field=models.TextField(choices=[('view_account', 'View account'), ('view_journal', 'View journal'), ('add_journal', 'Add journal'), ('modify_journal', 'Modify journal'), ('delete_journal', 'Delete journal')]), blank=True, default=list, null=True, size=None, verbose_name='permissions')),
                ('order', models.IntegerField(default=10, verbose_name='order')),
                ('computable', models.BooleanField(default=True)),
                ('account', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='roles', to='accounts.account', verbose_name='account')),
            ],
            options={
                'verbose_name': 'role',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('page_modules', models.JSONField(blank=True, null=True, verbose_name='account page modules')),
                ('roles', models.JSONField(blank=True, null=True, verbose_name='roles')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='memberships', to='accounts.accountrole')),
                ('user', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='memberships', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='accounts', to='accounts.accounttemplate', verbose_name='creation template'),
        ),
        migrations.AddField(
            model_name='account',
            name='members',
