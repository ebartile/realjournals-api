...
class Candles(Generic[_Candle]):
    ...
    def __init__(self, *, data: Union[DataFrame, _Candles, Iterable], flip=False, candle_class: Type[_Candle] = None):        
    ...
    def __getitem__(self, index) -> Union[_Candle, _Candles]:
    ...
    def rename(self, inplace=True, **kwargs) -> Union[_Candles, None]:
